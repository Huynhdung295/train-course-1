...
public interface UserRepository extends JpaRepository<User, UUID> {
    ...
    List<User> findByTenantIdAndDeletedAtIsNull(String tenantId);

    @Query("SELECT u FROM User u WHERE u.tenantId = :tenantId AND u.status = 'ACTIVE' AND u.deletedAt IS NULL")
